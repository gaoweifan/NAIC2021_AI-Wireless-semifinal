...
def rxModel(input_bits):
    ...
    temp = swin_unet_2d_base(temp, filter_num_begin=64, depth=1, stack_num_down=2, stack_num_up=2, 
                          patch_size=(2, 2), num_heads=[4, 4, 4, 4], window_size=[2, 2, 2, 2], num_mlp=256, shift_window=True, name="swin_unet")
