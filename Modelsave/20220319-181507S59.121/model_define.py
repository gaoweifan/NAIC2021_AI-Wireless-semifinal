...
def rxModel(input_bits):
    ...
    temp = swin_unet_2d_base(temp, filter_num_begin=256, depth=2, stack_num_down=2, stack_num_up=2, 
                          patch_size=(2, 2), num_heads=[2, 4, 8, 4], window_size=[2, 2, 2, 2], num_mlp=512, shift_window=True, name="swin_unet")
