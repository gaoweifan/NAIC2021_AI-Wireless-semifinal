...
def rxModel(input_bits):
    ...
    temp = layers.Conv2D(2, (7, 7), padding='same', name="conv2d_1_")(temp)
    temp = layers.BatchNormalization()(temp)
    temp = layers.LeakyReLU(alpha=0.1)(temp)
    # temp = layers.Activation('relu')(temp)

    temp = layers.Conv2D(8, (7, 7), padding='same', name="conv2d_2_")(temp)
    temp = layers.BatchNormalization()(temp)
    temp = layers.LeakyReLU(alpha=0.1)(temp)
    # temp = layers.Activation('relu')(temp)

    # temp = layers.Conv2D(2, (7, 7), padding='same', name="conv2d_1_2")(temp)
    # temp = layers.BatchNormalization()(temp)
    # temp = layers.LeakyReLU(alpha=0.1)(temp)
    # # temp = layers.Activation('relu')(temp)

    temp = layers.Conv2D(16, (7, 7), padding='same', name="conv2d_3_")(temp)
    temp = layers.BatchNormalization()(temp)
    temp = layers.LeakyReLU(alpha=0.1)(temp)
    # temp = layers.Activation('relu')(temp)

    temp = layers.Conv2D(2, (7, 7), padding='same', name="conv2d_4_")(temp)
    temp = layers.BatchNormalization()(temp)
    temp = layers.LeakyReLU(alpha=0.1)(temp)
    # temp = layers.Activation('relu')(temp)
